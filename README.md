...
.
  ...
  2. **Recommnedation on correct date for accuracy**:  --  Instructions within 2nd part of the assignment Challenge included using the from_date from the "Department Employee" table. However, to arrive at an accurate date for the most recent employee title, it may be recommended to instead use the from_date within the "Titles" table.   
